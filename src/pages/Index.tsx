  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-funnel mx-auto px-4 md:px-6 lg:px-8 py-20 md:py-28 lg:py-36">
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="mt-5 md:mt-6 text-base md:text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 font-body leading-relaxed">
              ...
              <p className="mt-4 text-accent font-heading font-semibold text-sm md:text-base">
            ...
            <div className="flex-shrink-0">
              <div className="w-64 h-80 md:w-80 md:h-[400px] lg:w-[400px] lg:h-[500px] rounded-2xl glass flex items-center justify-center">
      ...
      {/* DREAM OUTCOME */}
      <section>
        <div className="max-w-funnel mx-auto px-4 md:px-6 lg:px-8 py-20 md:py-24 lg:py-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-12 md:mt-16">
            {[
              ...
              <div
                key={item.title}
                className="glass rounded-2xl p-6 md:p-8 hover:scale-[1.02] transition-all duration-300 group"
              >
      ...
      {/* PROOF & CREDIBILITY */}
      <section>
        <div className="max-w-funnel mx-auto px-4 md:px-6 lg:px-8 py-20 md:py-24">
          <h2 className="font-heading text-2xl md:text-4xl lg:text-5xl font-bold text-foreground text-center">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 mt-12 md:mt-16">
            <div className="flex-shrink-0">
              <div className="w-56 h-56 md:w-64 md:h-64 rounded-full glass flex items-center justify-center border-2 border-primary/20">
                <div className="text-center text-muted-foreground">
        ...
        <div className="relative z-10 max-w-funnel mx-auto px-4 md:px-6 lg:px-8 py-20 md:py-24 lg:py-28">
          ...
          <div className="mt-12 md:mt-16 grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div key={step.day} className="glass rounded-2xl p-6 md:p-8 hover:scale-[1.02] transition-all duration-300">
